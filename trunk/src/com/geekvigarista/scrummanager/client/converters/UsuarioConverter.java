...
{
	private Usuario convert(HasValue<String> nome, HasValue<String> login, HasValue<String> senha, HasValue<Boolean> administrador)
	{
	...
	{
		Usuario user = convert(v.getNome(), v.getLogin(), v.getSenha(), v.getAdministrador());
